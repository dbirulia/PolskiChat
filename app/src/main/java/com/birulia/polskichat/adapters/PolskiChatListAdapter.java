package com.birulia.polskichat.adapters;
...
import com.birulia.polskichat.R;
...
public class PolskiChatListAdapter extends ArrayAdapter<Message> {
    private String mUserId;

    public PolskiChatListAdapter(Context context, String userId, List<Message> messages) {
